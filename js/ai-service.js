...
3. Consider color coordination, style harmony, and appropriateness for the occasion and weather
4. BE CREATIVE - try different combinations each time, don't repeat the same items
5. Provide the outfit as a JSON object with this structure:
{
  "items": [
