...
4. Consider color coordination, style harmony, and appropriateness for the occasion and weather
5. BE CREATIVE - try different combinations each time, don't repeat the same items
6. Provide the outfit as a JSON object with this structure:
{
  "items": [
...
4. DO NOT mix seasonal items inappropriately (e.g., no sandals with wool coats)
